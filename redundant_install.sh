...
# Script: install.sh
# Description: Installs CSEL on a Linux system/image. Allows you to delete this app once installed.
...
cp "$PROJECT_ROOT/dst/scoring_engine" /usr/local/bin/csel_SCORING_ENGINE_DO_NOT_TOUCH
